...
\input{content/chapters/hyphenation.tex}
...
\IfPackageLoaded{biblatex}{
  % add all .bib files:
  \addbibresource{content/bib/BibtexDatabase.bib}
  \addbibresource{content/bib/publications.bib}
  % \addbibresource{content/bib/BibtexData-anytopic.bib}
}% end: biblatex
...
\input{content/chapters/Z-GlossaryEntries.tex}

%% document content %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%\includeonly{
% content/chapters/0-title,
% content/chapters/0-Abstract,
% content/chapters/0-Introduction,
% content/chapters/1-Theory,
% content/chapters/2-Experiments,
% content/chapters/3-Results,
% content/chapters/4-Summery,
%} % end includeonly
...
% -- title page --
\include{content/chapters/0-title}
\cleardoublepage

% -- abstract --
% (only in phd thesis)
\include{content/chapters/0-Abstract} 
\cleardoublepage
% -- declaration --
% (only in bachelor/master thesis)
\input{content/chapters/Z-Declaration.tex}
...
\input{content/chapters/Z-Appendix.tex}

% -- only in phd thesis --->
\input{content/chapters/Z-Publications.tex}
\input{content/chapters/Z-CV.tex}
% <------------------------
...
\input{content/chapters/Z-Thanks.tex}

% add todo list (remove for final document!)
% \input{content/chapters/Z-Todo.tex}
