...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.4\textwidth]{content/images/testimage.png}
...
\begin{figure}[htb]
  \begin{subfigure}[b]{.45\linewidth}
    \centering
    \includegraphics[width=0.5\linewidth]{content/images/testimage.png}
...
\ifcsdef{lstStyleLaTeX}{%
  ...
  {content/chapters/template/latextutorial.tex}
}{}  
